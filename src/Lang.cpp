...
namespace ItemSearch::Lang
{
    ...
    static constexpr Strings s_German
    {
        ...
        /* optApiKeyPerms    */ "Ben\xc3\xb6" "tigte Berechtigungen: account, inventories, characters, builds (optional, f\xc3\xbcr Elite-Spec)",
        /* optLanguage       */ "Sprache",
        /* optSave           */ "Speichern",
    ...
    static constexpr Strings s_English
    {
        ...
        /* optApiKeyPerms    */ "Required permissions: account, inventories, characters, builds (optional, for elite spec)",
